...
const faqs = [
  {
    q: "How many notes can I generate on the free plan?",
    a: "The free plan allows 1 note generation per day. The limit resets at midnight UTC. Upgrade to Pro for unlimited generations.",
  },
  {
  ...
  },
  {
    ...
    a: "Go to the Pricing page, click 'Get Pro', and complete the ₹299/month payment via Razorpay. Your account is upgraded instantly after payment verification.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. After notes are generated you can download them as a PDF directly from the Generate page.",
  },
  {
  ...
  },
  {
    ...
    a: "We never store the video content or the generated notes on our servers beyond the time needed to produce them. Your account data (email, tier) is stored securely in Firebase.",
  },
  {
    q: "Can I cancel my Pro subscription?",
    a: "Yes. Email us at the address below with your account email and we'll process the cancellation immediately. We offer a no-questions-asked refund within 7 days of purchase.",
  },
];
...
const Support = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mailto = `mailto:aakash18swain@gmail.com?subject=${encodeURIComponent(
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pb-14 px-4">
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
          <a
            href="mailto:aakash18swain@gmail.com"
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">aakash18swain@gmail.com</p>
            </div>
          </a>
          <a
            href="/pricing"
